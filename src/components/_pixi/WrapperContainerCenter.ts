...
export default class WrapperContainerCenter implements IWrapper {
  protected _container: IWrapper
  protected _centerContainer: IWrapper
  ...
  constructor() {
    ...
    this._centerContainer
      .getContainer()
      .pivot.set(
        this._centerContainer.width / 2,
        this._centerContainer.height / 2
      )
    this._centerContainer.setPosition(
      { animation: false },
      this._centerContainer.width / 2,
      this._centerContainer.height / 2
    )
